...
void _duckdb_jdbc_udf_set_varchar_bytes(JNIEnv *env, jclass param0, jobject param1, jint param2, jbyteArray param3);

JNIEXPORT void JNICALL Java_org_duckdb_DuckDBNative_duckdb_1jdbc_1udf_1set_1varchar_1bytes(JNIEnv *env, jclass param0,
                                                                                           jobject param1, jint param2,
                                                                                           jbyteArray param3);

jbyteArray _duckdb_jdbc_udf_get_blob_bytes(JNIEnv *env, jclass param0, jobject param1, jint param2);
...
void _duckdb_jdbc_udf_set_blob_bytes(JNIEnv *env, jclass param0, jobject param1, jint param2, jbyteArray param3);

JNIEXPORT void JNICALL Java_org_duckdb_DuckDBNative_duckdb_1jdbc_1udf_1set_1blob_1bytes(JNIEnv *env, jclass param0,
                                                                                        jobject param1, jint param2,
                                                                                        jbyteArray param3);

jobject _duckdb_jdbc_udf_get_decimal(JNIEnv *env, jclass param0, jobject param1, jint param2);

JNIEXPORT jobject JNICALL Java_org_duckdb_DuckDBNative_duckdb_1jdbc_1udf_1get_1decimal(JNIEnv *env, jclass param0,
                                                                                       jobject param1, jint param2);

void _duckdb_jdbc_udf_set_decimal(JNIEnv *env, jclass param0, jobject param1, jint param2, jobject param3);
